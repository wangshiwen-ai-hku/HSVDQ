...
1. **Problem Formulation**:
    ...
    <div align="center">
        <img src="https://latex.codecogs.com/svg.latex?\min_{\mathbf{S}_i,%20\mathbf{T}_i}%20\|\mathbf{W}_i%20\mathbf{X}%20-%20\mathbf{T}_i%20\mathbf{S}_i%20\mathbf{X}\|^2\%20s.t.\%20\mathbf{1}^\top%20\mathbf{S}_i%20=%20\mathbf{1}^\top,%20\forall%20i" />
    </div>
...
2. **Alternating Direction Optimization**:
    ...
    <div align="center">
        <img src="https://latex.codecogs.com/svg.latex?\begin{align}\mathbf{S}_i^{k+1}&=\arg\min_{\mathbf{S}_i}\left\{\|\mathbf{W}_i\mathbf{X}-\mathbf{T}_i^k\mathbf{S}_i\mathbf{X}\|^2|\mathbf{1}^\top\mathbf{S}_i\mathbf{1}^\top\right\},\\\mathbf{T}_i^{k+1}&=\arg\min_{\mathbf{T}_i}\left\{\|\mathbf{W}_i\mathbf{X}-\mathbf{T}_i\mathbf{S}_i^{k+1}\mathbf{X}\|^2\right\}.\end{align}" />
    </div>
...
3. **Solving the $\mathbf{T}_i$-Subproblem**:
    ...
    <div align="center">
        <img src="https://latex.codecogs.com/svg.latex?\mathbf{T}_i^{k+1}=\mathbf{W}_i\mathbf{XX}^\top(\mathbf{S}_i^{k+1})^\top((\mathbf{S}_i)^{k+1}\mathbf{XX}^\top(\mathbf{S}_i^{k+1})^\top)^\dagger," />
    </div>
